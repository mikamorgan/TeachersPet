...
import com.example.teacherspet.teacher_view.skills_check.SC_Algo;
import com.example.teacherspet.teacher_view.skills_check.SC_BT;
import com.example.teacherspet.teacher_view.skills_check.SC_Lis;
import com.example.teacherspet.teacher_view.skills_check.SC_Poi;
import com.example.teacherspet.teacher_view.skills_check.SC_Rec;
import com.example.teacherspet.teacher_view.skills_check.SC_Rev;
import com.example.teacherspet.teacher_view.skills_check.SC_Sta;

public class Self_Study_Teacher_View extends AppCompatActivity {
    /************************************************************************
    ...
    public void openAlgorithms() {
        Intent intent = new Intent(this, SC_Algo.class);
    ...
    public void openBinary() {
        Intent intent = new Intent(this, SC_BT.class);
        String email = getIntent().getStringExtra("email");
        intent.putExtra("email", email);
        startActivity(intent);
    }
    ...
    public void openLists() {
        Intent intent = new Intent(this, SC_Lis.class);
        String email = getIntent().getStringExtra("email");
        intent.putExtra("email", email);
        startActivity(intent);
    }
    ...
    public void openPointers() {
        Intent intent = new Intent(this, SC_Poi.class);
        String email = getIntent().getStringExtra("email");
        intent.putExtra("email", email);
        startActivity(intent);
    }
    ...
    public void openRecursion() {
        Intent intent = new Intent(this, SC_Rec.class);
        String email = getIntent().getStringExtra("email");
        intent.putExtra("email", email);
        startActivity(intent);
    }
    ...
    public void openReview() {
        Intent intent = new Intent(this, SC_Rev.class);
        String email = getIntent().getStringExtra("email");
        intent.putExtra("email", email);
        startActivity(intent);
    }
    ...
    public void openStacks() {
        Intent intent = new Intent(this, SC_Sta.class);
        String email = getIntent().getStringExtra("email");
        intent.putExtra("email", email);
        startActivity(intent);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_self__study__teacher__view);
