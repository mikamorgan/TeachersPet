...
public class L_Recursion extends AppCompatActivity {
    ...
    public void openLink1() {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.geeksforgeeks.org/recursion/"));
    ...
    public void openLink2() {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.geeksforgeeks.org/tail-recursion/"));
        startActivity(intent);
    }
    ...
    public void openLink3() {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=c7VjS7ZZVWM&list=RDCMUCRIWTSgd7hGtZhx4RYoASEg&start_radio=1&t=0&ab_channel=SimpleSnippets"));
        startActivity(intent);
    }
    ...
    public void openLink4() {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=2mIERXU7wWY&list=PLGLfVvz_LVvQ9S8YSV0iDsuEU8v11yP9M&index=11&ab_channel=DerekBanas"));
        startActivity(intent);
    }
    ...
    public void openLink5() {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=B0NtAFf4bvU&ab_channel=CSDojo"));
        startActivity(intent);
    }
    ...
    public void openLink6() {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.programiz.com/cpp-programming/recursion"));
        startActivity(intent);
    }
    ...
    public void openLink7() {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/mostafa-saad/ArabicCompetitiveProgramming/blob/master/15%20C%2B%2B%20Programming%204%20Competitions/42%20C%2B%2B%20Programming%204%20Competitions%20-%20Recursion.cpp"));
        startActivity(intent);
    }
    ...
    public void openLink8() {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.khanacademy.org/computing/computer-science/algorithms/recursive-algorithms/a/recursion"));
        startActivity(intent);
    }
    ...
    public void openLink9() {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.proprofs.com/quiz-school/story.php?title=advanced-data-structures-algorithms"));
        startActivity(intent);
    }
    ...
    public void openLink10() {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.geeksforgeeks.org/algorithms-gq/recursion-gq/"));
        startActivity(intent);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l__recursion);
