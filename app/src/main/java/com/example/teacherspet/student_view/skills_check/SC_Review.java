...
public class SC_Review extends AppCompatActivity {
    /************************************************************************
     ...
     * 1044 Review topic. It has an instance of the
     ...
     * in the sc_review XML file, in the layout package
     ************************************************************************/
    ...
    //Current 1044 review material are in QuestionBank indices 0-19
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Lines 83-90 link the page content with the layout XML file
        setContentView(R.layout.activity_s_c__review);
        ...
        //Method to update the question and button text to populate 1044 review info
        updateQuestions();
         ...
         *  (still in 1044 review section- determined by index passed in).
         ***************************************************************************/
        ...
        mchoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mchoice1.getText() == answer) {
                    mscore++;
                    updateScore(mscore);
                    Toast.makeText(SC_Review.this, "CORRECT!", Toast.LENGTH_SHORT);
                    updateQuestions();
                }
            }
        });
