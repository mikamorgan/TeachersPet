...
public class SC_Binary_Trees extends AppCompatActivity {
     ...
     * Binary Tree topic. It has an instance of the
     ...
     * in the sc_binary_trees XML file, in the layout package
     ************************************************************************/
    ...
    //Current binary tree material are in QuestionBank indices 20-37
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Method to update the question and button text to populate binary tree info
        updateQuestions();
         ...
         *  (still in binary tree section- determined by index passed in).
         ***************************************************************************/
