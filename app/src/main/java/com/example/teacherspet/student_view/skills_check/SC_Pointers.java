 ...
 ************************************************************************/
     ...
     * Pointers topic. It has an instance of the
     ...
     * in the sc_pointers XML file, in the layout package
     ************************************************************************/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_s_c__pointers);
        ...
        //Method to update the question and button text to populate pointers info
        updateQuestions();
         ...
         *  (still in pointers section- determined by index passed in).
         ***************************************************************************/
        ...
        mchoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mchoice1.getText() == answer) {
                    mscore++;
                    updateScore(mscore);
                    Toast.makeText(SC_Pointers.this, "CORRECT!", Toast.LENGTH_SHORT);
                    updateQuestions();
                }
            }
        });
