...
public class SC_Recursion extends AppCompatActivity {
     ...
     * Recursion topic. It has an instance of the
     ...
     * in the sc_recursion XML file, in the layout package
     ************************************************************************/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_s_c__recursion);
        ...
        //Method to update the question and button text to populate recursion info
        updateQuestions();
         ...
         *  (still in recursion section- determined by index passed in).
         ***************************************************************************/
        ...
        mchoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mchoice1.getText() == answer) {
                    mscore++;
                    updateScore(mscore);
                    Toast.makeText(SC_Recursion.this, "CORRECT!", Toast.LENGTH_SHORT);
                    updateQuestions();
                }
            }
        });
